...
namespace GiocoDadiFerrari4H
{
    class Risorsa
    {
        ...
        {
            get { return AggiornaClassificaTotale(); }
        }
        private void AggiungiVittoria()
        {
            int m = 0, max = -1;
        ...
        private string[] OrdinaClassifica(string[] nomi, int[] valori) //string tema)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                //            break;
                //        case "hp":
                //            if (nomi[i] == "Nord") nomi[i] = "Slytherin";
                //            if (nomi[i] == "Sud") nomi[i] = "Hufflepuff";
                //            if (nomi[i] == "Est") nomi[i] = "Ravenclaw";
                //            if (nomi[i] == "Ovest") nomi[i] = "Gryffindor";
                //            break;
                //        case "pirati":
        ...
        private string[] AggiornaClassificaTotale()
        {
            ...
            punti[Est] = ce;
            punti[Ovest] = co;
           return OrdinaClassifica(nomi, punti);
        }
        public string[] ClassificaTurno//(string tema)
        {
            get
            {
                AggiungiVittoria();
